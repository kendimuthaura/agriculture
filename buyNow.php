<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $sql = "INSERT INTO transaction (bid, pid, name, city, mobile, email, pincode, addr, accountnumber)
                VALUES ('$bid', '$pid', '$name', '$city', '$mobile', '$email', '$pincode', '$addr','$account')";
        ...
        <div class="container">
            <center>
                <form method="post" action="buyNow.php?pid=<?= $pid; ?>" style="border: 1px solid black; padding: 15px;">
                    ...
                    <div class="row uniform">
                        <div class="4u 12u$(xsmall)">
                            <input type="text" name="accountnumber" id="accountnumber" value="" placeholder="accountnumber" required/>
                        </div>
                    </div>
                    <br />
                    <p>
